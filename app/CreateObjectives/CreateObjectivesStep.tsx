...
const CreateObjectivesStep = () => {
  ...
  useEffect(() => {
    ...
    return unsubscribe; // Retourner la fonction de nettoyage
  }, []);
  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>Quel objectif de pas souhaitez-vous atteindre aujourd’hui ?</Text>
        ...
        <Text style={styles.unitText}>Pas/JOUR</Text>
...
export default CreateObjectivesStep;
